...
export function InviteMemberDialog({
  ...
  const expiryOptions = [
    { value: '1', label: t('expiry.one') },
    { value: '7', label: t('expiry.seven') },
    { value: '30', label: t('expiry.thirty') },
  ];
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const message = t('shareMessage', {
      accountName,
      days: result?.expiresInDays ?? Number(expiry),
      url,
    });
        ...
        {result ? (
          ...
          <>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground">{t('validFor')}</Label>
                <Select
                  value={expiry}
