  ...
  if (loading || profileLoading) {
    return (
      <div className="flex items-center justify-center py-16 text-muted-foreground">
        <Loader2 className="mr-2 h-4 w-4 animate-spin" /> {tCommon('states.loadingWithEllipsis')}
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <Sparkles className="h-4 w-4 text-primary" /> {t('providerKeyTitle')}
            </CardTitle>
            <CardDescription>
              {t('providerKeyDescription')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={t('embeddingsPlaceholder')}
                disabled={disabled}
                autoComplete="off"
              />
              <p className="text-xs text-muted-foreground">
                {t('embeddingsDescription', {
                  sameKey: provider === 'openai' ? t('sameKeySuffix') : '',
                })}
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t('behaviourTitle')}</CardTitle>
            <CardDescription>
              {t('behaviourDescription')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
