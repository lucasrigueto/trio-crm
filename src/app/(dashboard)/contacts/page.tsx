...
export default function ContactsPage() {
  ...
  async function handleBulkDelete() {
    ...
    if (error) {
      toast.error(t('errors.deleteMany'));
    } else {
      toast.success(t('success.deletedMany', { count: ids.length }));
      setSelected(new Set());
      fetchContacts();
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {t('description')} {totalCount > 0 && t('total', { count: totalCount })}
          </p>
        </div>
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              {t('deleteConfirm', { name: deleteTarget?.name || deleteTarget?.phone || '' })}
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">
              {t('deleteContactsTitle', { count: selected.size })}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
              {t('deleteBulkConfirm', { count: selected.size })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="bg-popover border-border">
            <Button
